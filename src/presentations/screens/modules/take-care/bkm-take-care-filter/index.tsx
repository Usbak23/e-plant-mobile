...
import {useForemanOptions, useForemanTakeCareOptions} from '@app/domain/states/block/hooks'
...
const BKMTakeCareFilter = () => {
  ...
  //old
  // const users = useForemanTakeCareOptions(divison, true)
  ...
  const onSubmit = () => {
    ...
    dispatch(
      actions.getBKMTakeCareMobile.request({
        loading: true,
        data: {
    ...
    navigation.navigate(Routes.BKM_TAKE_CARE_LIST, {
      bkmData: {organization: org, date: getValues('date'), division: div, foreman: usr},
    })
  }

  return (
    <SafeAreaView style={styles.root}>
      <Header title="Buku Kerja Mandor Rawat" />
...
export default BKMTakeCareFilter

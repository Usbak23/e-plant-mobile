...
const ICON_SIZE = 17
const BKMDetailInfo = ({bkmData}: any) => {
  return (
        ...
        <View style={styles.itemWrapper}>
          ...
          <View style={styles.leftSpacer}>
            ...
            <Text color={theme.colors.textThinBlack} size={12}>
              {moment(bkmData?.date).format('DD MMMM YYYY') || '-'}
            </Text>
          </View>
        </View>
        <View style={[styles.itemWrapper]}>
      ...
      <View style={[styles.container,]}>
        ...
        <View style={styles.itemWrapper}>
          ...
          <View style={styles.leftSpacer}>
            ...
            <Text color={theme.colors.textThinBlack} size={12}>
              {`${bkmData?.foreman?.name} - ${bkmData?.foreman?.nip} - ${bkmData?.foreman?.role?.name}` || '-'}
            </Text>
          </View>
        </View>
      </View>

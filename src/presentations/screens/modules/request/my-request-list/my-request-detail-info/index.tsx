...
const ICON_SIZE = 17
const MyRequestDetailInfo = ({data}: any) => {
  return (
      ...
      <View style={styles.container}>
        <View style={styles.itemWrapper}>
          ...
          <View style={[styles.leftSpacer, {flex: 1}]}>
            <Text style={styles.itemTitle} size={10.5}>
              Organisasi
            </Text>
            <Text maxLines={1} color={theme.colors.textThinBlack} size={11}>
        ...
        <View style={[styles.itemWrapper]}>
          ...
          <View style={[styles.leftSpacer, {flex: 1}]}>
            ...
            <Text color={theme.colors.textThinBlack} size={11} maxLines={1}>
              {data?.division?.label || '-'}
            </Text>
          </View>
        </View>
...
export default MyRequestDetailInfo

...
const WareHousemanagementFilter = () => {
  ...
  const onSubmit = (form: any) => {
    ...
    navigation.navigate(Routes.WAREHOUSE_MANAGEMENT_LIST, {...obj})
  }
    ...
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView style={styles.scroll}>
        ...
        <Button disabled={!isValid} onPress={handleSubmit(onSubmit)}>
          <Text color="white">Pilih Manajemen Gudang</Text>
        </Button>
      </ScrollView>
    </SafeAreaView>
  )
...
export default WareHousemanagementFilter

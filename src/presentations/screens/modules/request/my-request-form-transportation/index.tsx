...
import {useBlockOptions, useBlockOptionsByOrganization} from '@app/domain/states/block/hooks'
import {IMyRequest, IMyRequestBlock} from '@app/models/eplant/MyRequest'
...
let validationSchema = yup.object().shape({
  ...
  itemId: yup.string().required('Transportasi wajib diipilih').typeError('Masukkan transportasi dengan benar'),
  qty: yup
    .number()
...
const MyRequestFormTransportation = () => {
  ...
  const items = useItemOptions('Kendaraan', isEdit ? req?.division?.organization?.id : parent?.organization?.value)
...
export default MyRequestFormTransportation

...
interface Props {
  isAllowedToOrganizeBKMHarvest?: boolean
  bkmData?: {
    division: Division
    foreman: User
...
const BKMCard = ({ bkmData, ...props }: Props) => {
  ...
  const isBkmEmpty = props?.item?.empty_bkm //TODO: Recheck again

  return (
    <TouchableOpacity
      onPress={() => navigation.navigate(Routes.BKM_EMPLOYEE_DETAIL, { item: props.item, bkmData })}
      ...
      <View>
        ...
        <View style={styles.header}>
          ...
          {props.isAllowedToOrganizeBKMHarvest && <MenuButton />}
        </View>

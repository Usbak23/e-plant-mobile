...
import {RefreshControl, SafeAreaView, ScrollView, TouchableOpacity, View, TextInput} from 'react-native'
import styles from '@app/presentations/screens/modules/attendance/attendance-detail/styles'
import {Button, Header, ListFilter, ModalAsk, Text} from '@app/presentations/_shared-components'
